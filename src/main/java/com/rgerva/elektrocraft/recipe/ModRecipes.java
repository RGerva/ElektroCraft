...
public class ModRecipes {
    ...
    public static final Supplier<RecipeSerializer<ResistorAssembleRecipe>> RESISTOR_ASSEMBLE_SERIALIZER =
    ...
    public static final Supplier<RecipeType<ResistorAssembleRecipe>> RESISTOR_ASSEMBLE_TYPE =
            TYPES.register("resistor_assemble", () -> new RecipeType<ResistorAssembleRecipe>() {
                @Override
    ...
    public static final Supplier<RecipeType<ChargerStationRecipe>> CHARGER_STATION_TYPE =
            TYPES.register("charger_station", () -> new RecipeType<ChargerStationRecipe>() {
                @Override
                public String toString() {
