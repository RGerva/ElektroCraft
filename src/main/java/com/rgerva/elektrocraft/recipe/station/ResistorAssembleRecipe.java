...
public record ResistorAssembleRecipe(ItemStack output, IngredientWithCount[] inputs) implements ModRecipes.ModBasicRecipe<RecipeInput> {
    @Override
    ...
    public static final class Serializer implements RecipeSerializer<ResistorAssembleRecipe> {
        private final MapCodec<ResistorAssembleRecipe> CODEC = RecordCodecBuilder.mapCodec((instance) -> {
        ...
        private final StreamCodec<RegistryFriendlyByteBuf, ResistorAssembleRecipe> STREAM_CODEC = StreamCodec.of(
