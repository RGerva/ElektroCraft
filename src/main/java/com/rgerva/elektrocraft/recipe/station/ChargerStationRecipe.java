/**
 * Record: ChargerStationRecipe <T> Immutable data structure for simplified object representation.
 *
...
public record ChargerStationRecipe(ItemStack output, IngredientWithCount[] inputs)
  ...
  public static final class Serializer implements RecipeSerializer<ChargerStationRecipe> {
    ...
    private final MapCodec<ChargerStationRecipe> CODEC =
    ...
    private final StreamCodec<RegistryFriendlyByteBuf, ChargerStationRecipe> STREAM_CODEC =
