...
public class ModOresUtils {
  ...
  public static List<Block> getOres() {
    return List.of(ModBlocks.LEAD_ORE.get(), ModBlocks.TIN_ORE.get());
  }

  public static List<Block> getDeepslateOre() {
    return List.of(ModBlocks.LEAD_DEEPSLATE_ORE.get(), ModBlocks.TIN_DEEPSLATE_ORE.get());
  }

  public static List<Block> getNetherOre() {
    return List.of(ModBlocks.LEAD_NETHER_ORE.get(), ModBlocks.TIN_NETHER_ORE.get());
  }

  public static List<Block> getEndOre() {
    return List.of(ModBlocks.LEAD_END_ORE.get(), ModBlocks.TIN_END_ORE.get());
  }
}
