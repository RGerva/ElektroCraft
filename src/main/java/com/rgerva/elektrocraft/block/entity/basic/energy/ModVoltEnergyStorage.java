/**
 * Generic Class: VoltEnergyStorage <T> A generic structure that works with type parameters.
 *
...
public class ModVoltEnergyStorage implements IEnergyStorage, IVoltEnergy, IEnergyPacketUpdate {
  ...
  public ModVoltEnergyStorage(
      long capacity, long maxReceive, long maxExtract, boolean allowInternalUse) {
