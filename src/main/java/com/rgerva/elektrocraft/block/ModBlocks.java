...
public class ModBlocks {
  ...
  public static final DeferredBlock<Block> LEAD_DEEPSLATE_ORE =
      registerBlock(
          "lead_deepslate_ore",
          (properties) ->
              new DropExperienceBlock(
  ...
  public static final DeferredBlock<Block> LEAD_NETHER_ORE =
      registerBlock(
          "lead_nether_ore",
          (properties) ->
              new DropExperienceBlock(
  ...
  public static final DeferredBlock<Block> LEAD_END_ORE =
      registerBlock(
          "lead_end_ore",
          (properties) ->
              new DropExperienceBlock(
  ...
  public static final DeferredBlock<Block> LEAD_RAW_BLOCK =
      registerBlock(
          "lead_raw_block",
          (properties) ->
              new Block(
  ...
  public static final DeferredBlock<Block> TIN_DEEPSLATE_ORE =
      registerBlock(
          "tin_deepslate_ore",
          (properties) ->
              new DropExperienceBlock(
  ...
  public static final DeferredBlock<Block> TIN_NETHER_ORE =
      registerBlock(
          "tin_nether_ore",
          (properties) ->
              new DropExperienceBlock(
  ...
  public static final DeferredBlock<Block> TIN_END_ORE =
      registerBlock(
          "tin_end_ore",
          (properties) ->
              new DropExperienceBlock(
  ...
  public static final DeferredBlock<Block> TIN_RAW_BLOCK =
      registerBlock(
          "tin_raw_block",
          (properties) ->
              new Block(
  ...
  public static final DeferredBlock<Block> RESISTOR_ASSEMBLE =
      registerBlock(
          "resistor_assemble",
          (properties) ->
              new ResistorAssembleBlock(
                  BlockBehaviour.Properties.of()
  ...
  public static final DeferredBlock<Block> CHARGING_STATION =
      registerBlock(
          "charging_station",
          (properties) ->
