/**
 * Generic Class: ResistorAssembleScreen <T> A generic structure that works with type parameters.
 *
...
public class ResistorAssembleScreen extends AbstractContainerScreen<ResistorAssembleMenu> {
  ...
  public ResistorAssembleScreen(
      ResistorAssembleMenu menu, Inventory playerInventory, Component title) {
    super(menu, playerInventory, title);
    TEXTURE =
        ResourceLocation.fromNamespaceAndPath(
            ElektroCraft.MOD_ID, "textures/gui/container/resistor_assemble_gui.png");
  }
