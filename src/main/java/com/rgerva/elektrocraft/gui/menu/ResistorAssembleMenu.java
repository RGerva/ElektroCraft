/**
 * Generic Class: ResistorAssembleMenu <T> A generic structure that works with type parameters.
 *
...
public class ResistorAssembleMenu extends AbstractContainerMenu {
  ...
  public ResistorAssembleMenu(int containerId, Inventory inventory, BlockEntity blockEntity) {
    ...
    this.addSlot(
        new SlotItemHandler(
            this.entity.itemHandler, ResistorAssembleEntity.BLANK_RESISTOR_SLOT, 9, 35) {
          @Override
    ...
    this.addSlot(
        new SlotItemHandler(
            this.entity.itemHandler, ResistorAssembleEntity.FIRST_DYE_SLOT, 48, 35) {
          @Override
          public boolean mayPlace(ItemStack stack) {
    ...
    this.addSlot(
        new SlotItemHandler(
            this.entity.itemHandler, ResistorAssembleEntity.SECOND_DYE_SLOT, 68, 35) {
          @Override
          public boolean mayPlace(ItemStack stack) {
            return stack.getItem() instanceof DyeItem;
          }
    ...
    this.addSlot(
        new SlotItemHandler(
            this.entity.itemHandler, ResistorAssembleEntity.THIRD_DYE_SLOT, 87, 35) {
          @Override
          public boolean mayPlace(ItemStack stack) {
            return stack.getItem() instanceof DyeItem;
          }
    ...
    this.addSlot(
        new SlotItemHandler(this.entity.itemHandler, ResistorAssembleEntity.OUTPUT_SLOT, 147, 35) {
          @Override
          public boolean mayPlace(ItemStack stack) {
            return false;
          }
  ...
  public boolean stillValid(Player player) {
    return stillValid(
        ...
        player,
        ModBlocks.RESISTOR_ASSEMBLE.get());
  }
